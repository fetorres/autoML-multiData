...
class BaseC(object):
    ...
    def plot(self, X, title="Clustering", pdffile='clusters.pdf', show=True):
        ...
        with PdfPages(pdffile) as pdf:
            # print out status messages because this routine takes a LONG time
            print("Starting to compute data to be plotted.")
            fig = plt.figure()
            ...
            pdf.savefig()
            print("computing Random projection to 2D")
