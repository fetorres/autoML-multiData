...
public class Controller implements IView {
	...
	public void actionMenuEditCreateHierarchy() {
		...
		ARXWizard<HierarchyWizardResult<?>> wizard = new HierarchyWizard(this, attr, builder, type, model.getLocale(),
				data);
	 ...
	 * @return
	 */
	public String actionShowInputDialog(final Shell shell, final String header, final String text, final String initial,
	 ...
	 * @return
	 */
	public List<String> actionShowMultiSelectionDialog(Shell shell, String title, String text, List<String> elements,
