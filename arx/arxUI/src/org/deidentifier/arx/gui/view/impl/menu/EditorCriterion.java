...
public abstract class EditorCriterion<T extends ModelCriterion> {
     ...
     * @return
     */
    protected Label createInstructions(Composite parent, String s) {
    	final Label label = new Label(parent, SWT.BORDER | SWT.LEFT | SWT.WRAP);
    	GridData gd = new GridData(GridData.FILL_HORIZONTAL);
    	gd.heightHint = 50; // set the height of the label
